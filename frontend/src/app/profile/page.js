...
export default function ProfilePage() {
    ...
    return (
        <div className="min-h-screen font-sans" style={{ backgroundColor: 'rgba(55, 151, 169, 0.04)' }}>
            {/* Hero Header */}
            <div className="relative overflow-hidden rounded-b-[2.5rem] px-4 pt-6 pb-28 sm:px-6" style={{ background: 'linear-gradient(135deg, #082231 0%, #0a505c 100%)' }}>
                <div className="mx-auto max-w-3xl">
                    <div className="flex items-center justify-between mb-8">
                        ...
                        <button onClick={() => setShowModal(true)} className="rounded-xl bg-white/15 border border-white/20 px-4 py-2 text-xs font-bold text-white hover:bg-white/25 transition-all">
                            Edit Login
                        </button>
                    </div>
                    <div className="flex items-center gap-5">
                        ...
                        <div className="min-w-0">
                            ...
                            <p className="text-sm text-white/60 font-medium">@{profile?.username}</p>
            ...
            {/* Content */}
            <div className="mx-auto max-w-3xl -mt-16 px-4 pb-8 sm:px-6 space-y-5">
